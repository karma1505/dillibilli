...
function Travel() {
    return (
        <div>
            <div className="m-20">
                <h1 className="text-black text-3xl lg:text-5xl font-extrabold flex justify-center">Travel</h1>
            </div>
                ...
                <div className="flex flex-wrap -m-4 text-center ">
                    <div className="p-4 lg:w-1/4 md:w-1/2 w-full ">
                        <div className="border-1 shadow-xl border-gray-100 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 h-64">
                            ...
                            <h2 className="title-font font-medium text-3xl text-gray-900">Airport</h2>
                            <p className="leading-relaxed">47 km away from Shimla Airport
                                58 km away from Chandigarh Airport</p>
                        </div>
                    </div>
                    <div className="p-4 lg:w-1/4 md:w-1/2 w-full ">
                        <div className="border-1 shadow-xl border-gray-100 px-4 py-6 rounded-lg  transform transition duration-500 hover:scale-110 h-64">
                            ...
                            <h2 className="title-font font-medium text-3xl text-gray-900">By Car</h2>
                            <p className="leading-relaxed">5 hours from Delhi NCR
                                2 hours away from Shimla
                                2 hours from Chail
                                1 hour from Chandigarh
                                30 minutes from Kasauli
                                30 minutes from Solan</p>
                        </div>
                    </div>
                    <div className="p-4 lg:w-1/4 md:w-1/2 w-full">
                        <div className="border-1 shadow-xl border-gray-100 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 h-64">
                            ...
                            <h2 className="title-font font-medium text-3xl text-gray-900">By Rail</h2>
                            <p className="leading-relaxed">Near the Kalka-Shimla Toy Train Station Of Dharampur</p>
                        </div>
                    </div>
                    <div className="p-4 lg:w-1/4 md:w-1/2 w-full">
                        <div className="border-1 shadow-xl border-gray-100 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 h-64">
                            ...
                            <h2 className="title-font font-medium text-3xl text-gray-900">Connectivity</h2>
                            <p className="leading-relaxed">Well connected with the Chandigarh-Shimla 4 lane highway</p>
                        </div>
                    </div>
                </div>
            </div>
