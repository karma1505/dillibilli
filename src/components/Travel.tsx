        ...
        <div>
            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-wrap -m-4 text-center">
                    ...
                    <div className="p-4 lg:w-1/4 md:w-1/2 w-full">
                        <div className="border-1 shadow-xl border-gray-100 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 h-64">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 mb-3 inline-block -mt-16" viewBox="0 0 24 24"><path fill="none" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 19L8 5m8 0l4 14M12 8V6m0 7v-2m0 7v-2" /></svg>
