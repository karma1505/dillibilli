...
const BronzeRoom = () => {
    return (
        <div className="h-screen py-10 p-4 w-full">
            ...
            <div>
                <h1 className="text-black dark:text-white text-3xl lg:text-5xl font-normal text-center m-20">More In The Golden Bedroom</h1>
                ...
                <ol className="sm:flex items-center justify-between m-20 lg:m-40">
                    ...
                    <li className="relative flex mb-6 sm:mb-0">
                        ...
                        <div className="mt-3 m-4 sm:pe-8">
                            <h3 className="text-lg font-normal text-gray-900 dark:text-white">En-suite Jacuzzi</h3>
                        </div>
                    </li>
                    <li className="relative flex mb-6 sm:mb-0">
                        <div className="flex items-center">
                        ...
                        <div className="mt-3 m-4 sm:pe-8">
                            <h3 className="text-lg font-normal text-gray-900 dark:text-white">Private Pool</h3>
                        </div>
                    </li>
                    <li className="relative flex mb-6 sm:mb-0">
                        <div className="flex items-center">
...
const SkeletonTwo = () => {
    return (
        <div>
            <p className="text-4xl text-white">The Jacuzzi Experience</p>
            <p className="text-base text-white"></p>
        </div>
    );
};
...
const SkeletonFour = () => {
    return (
        <div>
            <p className="text-4xl text-white">Scenic Forest Views</p>
            <p className="text-base text-white"></p>
        </div>
    );
};
...
const cards = [
    ...
    },
    {
        ...
        thumbnail: "/goldenjacuzzi.png"
    },
    {
        id: 3,
        content: <SkeletonThree />,
        className: "col-span-1",
        thumbnail: "/goldenpool.png"
    },
    {
        id: 4,
        content: <SkeletonFour />,
        className: "md:col-span-2",
        thumbnail: "/golden2.png"
    },
];
